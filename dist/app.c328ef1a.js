...
function newsFeed() {
  ...
  var newsList = []; // 템플릿 => 명확한 구조 파악 가능, 복잡도 감소 가능
  ...
  function makeComment(comments) {
    ...
    for (var _i = 0; _i < comments.length; _i++) {
      ...
      if (comments[_i].comments.length > 0) {
        commentString.push(makeComment(comments[_i].comments, called + 1)); //끝을 알 수 없는 구조일 때 재귀 호출
      }
    }
